...
/**
 * Model for table: قيود_الزواج
 * 
 * @property int $id
 * @property \Carbon\Carbon $created_at
 * @property \Carbon\Carbon $updated_at
 */
class MarriageEntry extends Model
{
    use HasFactory;
