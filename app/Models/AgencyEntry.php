...
/**
 * Model for table: قيود_الوكالات
 * 
 * @property int $id
 * @property \Carbon\Carbon $created_at
 * @property \Carbon\Carbon $updated_at
 */
class AgencyEntry extends Model
{
    use HasFactory;
