...
/**
 * Model for table: قيود_القسمة
 * 
 * @property int $id
 * @property \Carbon\Carbon $created_at
 * @property \Carbon\Carbon $updated_at
 */
class PartitionEntry extends Model
{
    use HasFactory;
