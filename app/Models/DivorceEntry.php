...
/**
 * Model for table: قيود_الطلاق
 * 
 * @property int $id
 * @property \Carbon\Carbon $created_at
 * @property \Carbon\Carbon $updated_at
 */
class DivorceEntry extends Model
{
    use HasFactory;
